...
// SystemVerilog created from loop_pipeline_i_iord_bl_do_unnamed_1_loop_pipeline29
...
module loop_pipeline_i_iord_bl_do_unnamed_1_loop_pipeline29 (
    ...
    wire [63:0] ip_dsdk_adapt_bitselect_b;
    ...
    assign ip_dsdk_adapt_bitselect_b = iord_o_data[63:0];

    // ip_dsdk_adapt_cast(BITSELECT,8)
    assign ip_dsdk_adapt_cast_b = ip_dsdk_adapt_bitselect_b[63:0];

    // dupName_0_sync_out_aunroll_x(GPOUT,15)@2
    assign out_o_data_0 = ip_dsdk_adapt_cast_b;
